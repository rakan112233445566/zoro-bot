...
setInterval(() => {
  http.get(`http://zoro-bot2.glitch.me/`);
}, 280000);
...
const admin = "-";
var owner = "652883476663762966"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity("-help" ); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفرك
  ...
  if (args[0] == `${prefix}cr`) {
    ...
    try {
      let role = await message.guild.createRole({
        name: args.slice(2).join(" ") || "رتبا جديده",
...
client.on("message", pixelbot => {
  // itzZa1D - Codes Team.
  if (pixelbot.content.startsWith(prefix + "حسابي")) {
    // itzZa1D - Codes Team.
    ...
    pixelbot.guild.fetchInvites().then(invites => {
      ...
      let pixeluser = new Discord.RichEmbed() // itzZa1D - Codes Team.
        ...
        .addField("**✽ اسمك :**   ", pixelbot.author.username, true)
        ...
        .addField("**✽ عدد دعوتك لسيرفر  :**    ", inviteCount, true)
...
client.on("message", zaid => {
  if (zaid.content === "البوت") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**عدد السيرفرت الي مدخله البوت ** :  ", `» ${client.guilds.size}`, true)
      .addField("**Channels** : ", `» ${client.channels.size} `, true)
      .addField("**Users** : ", `» ${client.users.size} `, true)
      .addField("**اسم البوت ** :  ", `» ${client.user.tag} `, true)
      .addField("**صاحب البوت** :  ", `» <@652883476663762966>`, true) // تعديل مهم عدل هذا الرقم لايدي حسابك
      .setImage(
        ""
      )
...
client.on("message", async message => {
  if (message.content.startsWith(prefix + "لالالالالالالالالالالالالالالالالالالالالالاالالالالالالالالالالالالالاللالالالالالالالالالالالالالا------------------")) {
    const invite = `**رابط البوت(${await client.generateInvite()})\
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "رابط السيرفر")) {
...
client.on("message", message => {
  if (message.content.split(" ")[0] == `باند`) {
    ...
    let reason = message.content
      ...
      .join(" ");
    if (!user)
      return message.channel.send(`عشان تبند اكتب: باند @منشن العضو السبب`);
    if (!reason) reason = "ايش السبب";
    if (user.user.id === message.author.id)
      return message.channel.send("لا تبند نفسك");
    if (
...
client.on("message", message => {
  ...
  if (command == prefix + "فك") {
    ...
    if (args == "الجميع") {
      ...
      return message.channel.send("**تم فك الباند عن الجميع**");
    }
    if (!args)
      return message.channel.send("**عشان تفك الباند اكتب فك @منشن العضو وا اذا تبي تفك البند عن الجميع اكتب فك الجميع**");
    message.guild
      .unban(args)
      .then(m => {
...
client.on("message", message => {
  if (message.content === "الدعم الفني") {
    let embed = new Discord.RichEmbed()
      .setAuthor(message.author.username)
      .setColor("#9B59B6")
      .addField(
        " ** :gear: سيرفر الدعم الفني للبوت :gear: **",
        "  **https://discord.gg/JKpmR2g*"
      );
...
client.on("message", message => {
  if (message.author.bot) return;
  if (message.content === prefix + "العامه") {
    message.channel.send(
...
**__الاوامر العامه__** 
**  عشان تطلع معلومات البوت  /  البوت ** 
** 
**  عشان يطلع معلومات عنك  /  -حسابي** 
** 
**  عشان يعرض صورتك  /  -افتار**
...
client.on("message", message => {
  if (message.author.bot) return;
  if (message.content === prefix + "الاداريه") {
    message.channel.send(
...
** -  https://glitch.com/edit/#!/music-m7med اذا وجهتك مشكلة i cant find any thing روح هذا مقطع https://youtu.be/R6O5CyZJNVw  | شرح بوت ميوزك يعمل 24 ساعة **
...
client.on("message", message => {
  if (message.author.bot) return;
  if (message.content === prefix + "الحمايه") {
...
> ** الاوامر العامه ** **  -العامه  **
> ** **
> ** الاوامرالاداريه ** ** -الاداريه   **
> ** **
> ** اوامر الحمايه (لصاحب السيرفر فقط)** ** -الحمايه**
 **__Done__** 
   `);
  }
});
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('جرار')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('محنا')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
